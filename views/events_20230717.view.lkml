# The name of this view in Looker is "Events 20230717"
view: events_20230717 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ga4_export.events_20230717` ;;
...
# The name of this view in Looker is "Events 20230717 Items"
view: events_20230717__items {
  ...
  dimension: events_20230717__items {
    type: string
    hidden: yes
    sql: events_20230717__items ;;
  }
...
# The name of this view in Looker is "Events 20230717 Event Params"
view: events_20230717__event_params {
  ...
  dimension: events_20230717__event_params {
    type: string
    hidden: yes
    sql: events_20230717__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
# The name of this view in Looker is "Events 20230717 User Properties"
view: events_20230717__user_properties {
  ...
  dimension: events_20230717__user_properties {
    type: string
    hidden: yes
    sql: events_20230717__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
