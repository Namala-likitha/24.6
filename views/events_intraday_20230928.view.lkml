# The name of this view in Looker is "Events Intraday 20230928"
view: events_intraday_20230928 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ga4_export.events_intraday_20230928` ;;
...
# The name of this view in Looker is "Events Intraday 20230928 Items"
view: events_intraday_20230928__items {
  ...
  dimension: events_intraday_20230928__items {
    type: string
    hidden: yes
    sql: events_intraday_20230928__items ;;
  }
...
# The name of this view in Looker is "Events Intraday 20230928 Event Params"
view: events_intraday_20230928__event_params {
  ...
  dimension: events_intraday_20230928__event_params {
    type: string
    hidden: yes
    sql: events_intraday_20230928__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
# The name of this view in Looker is "Events Intraday 20230928 User Properties"
view: events_intraday_20230928__user_properties {
  ...
  dimension: events_intraday_20230928__user_properties {
    type: string
    hidden: yes
    sql: events_intraday_20230928__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
