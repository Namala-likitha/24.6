# The name of this view in Looker is "Events 20210309"
view: events_20210309 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ga4_export.events_20210309` ;;
...
# The name of this view in Looker is "Events 20210309 Items"
view: events_20210309__items {
  ...
  dimension: events_20210309__items {
    type: string
    hidden: yes
    sql: events_20210309__items ;;
  }
...
# The name of this view in Looker is "Events 20210309 Event Params"
view: events_20210309__event_params {
  ...
  dimension: events_20210309__event_params {
    type: string
    hidden: yes
    sql: events_20210309__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
# The name of this view in Looker is "Events 20210309 User Properties"
view: events_20210309__user_properties {
  ...
  dimension: events_20210309__user_properties {
    type: string
    hidden: yes
    sql: events_20210309__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
