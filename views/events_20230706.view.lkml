...
view: events_20230706 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ga4_export.events_20230706` ;;
...
view: events_20230706__items {
  ...
  dimension: events_20230706__items {
    type: string
    hidden: yes
    sql: events_20230706__items ;;
  }
...
view: events_20230706__event_params {
  ...
  dimension: events_20230706__event_params {
    type: string
    hidden: yes
    sql: events_20230706__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
view: events_20230706__user_properties {
  ...
  dimension: events_20230706__user_properties {
    type: string
    hidden: yes
    sql: events_20230706__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
